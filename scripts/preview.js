$(function() {
    ...
    $("#foster-made").click(function() {
        ...
        $("#demo-description").append(
            ...
            "My position there was CMS Developer Apprentice mostly managing the back end. " +
            "The languages and CMS tools I used were PHP, Twig, ExpressionEngine 5, and Craft3. " +
            "\n My main task there was administering bug fixes on their addon call the " +
    ...
    $("#think-of-us").click(function() {
        ...
        $("#demo-description").append(
            ...
            "I apprenticed/volunteered here for 2 years. During those two years I had the pleasure of do the Hack Foster Care NYC. " +
            "After that I got involved in their internal hackathons where I got my first intro into C# and object oriented programming." +
            "</p>"
        );
